...
const Color mainColor = Color(0XFF06AB8D);
const Color electronicColor = Color(0XFFF3D9E8);


const Color mainCover = Color(0XFFF3D9E8);
const Color body = Color(0XFFE9F1F5);
