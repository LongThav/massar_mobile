...
class _ChatViewState extends State<ChatView> {
  ...
  late AuthFirebaseController authProvider;

  @override
  void initState() {
    super.initState();
    chatProvider = context.read<ChatController>();
    authProvider = context.read<AuthFirebaseController>();
  ...
  void readLocal() {
    ...
    //updateFirestoreData
    chatProvider.updateChating(FirestoreConstants.pathUserCollection,
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      scrollController.animateTo(0,
       ...
       const SnackBar(content: Text('Nothing to send', style: TextStyle(color: Colors.grey),));
    }
  }
